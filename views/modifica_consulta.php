...
<body>
    <?php require 'partials/menu.php'; echo $menu;?>    
         ...
         <div class="card" style="width: 90%;">
           <div class="card-body">
             <button id="ayuda" class="btn btn-primary">Ayuda</button><kbd></kbd>
             <div class="container">
                   ...
                   <table class="table table-bordered">
                       ...
                       <tr>
                           ...
                           <label for="ConsultasFolio">Numero de folio de atención:</label>
                               <input type="text" name="ConsultasFolio" id="ConsultasFolio"  value= "<?php echo $folio ?>" readonly>
                           </td>
                           <td class="text-center w-50">
    ...
    <script src="js/modifica_consulta.js"></script>
    <?php echo $scripts?>
</body>
</html>