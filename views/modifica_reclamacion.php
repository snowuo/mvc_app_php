<?php
    $token = isset($_SESSION['token_reune']) ? $_SESSION['token_reune'] : '';
?>
<!DOCTYPE html>
<html lang="es-LA">
<head>
...
<body>
                   ...
                   <table class="table table-bordered">
                       ...
                       <tr>
                        ...
                        <tr>
                            <td class="text-center w-50">
                                ...
                                <input type="text" name="RecFolioAtencion" id="RecFolioAtencion" value= "<?php echo $folio ?>" readonly>
                            </td>
                            <td class="text-center w-50">
                       ...
                       <tr>
                            <td class="text-center w-50">
                                ...
                                <select name="RecCausaMotivo" id="RecCausaMotivo" style="width:200px" required>
    ...
    <script type="text/javascript">
        ...
        var id_queja_borrar = "<?php echo $_GET['id']?>"        
    </script>
    <script src="js/modifica_reclamacion.js"></script>
    <?php echo $scripts?>
</body>
</html>